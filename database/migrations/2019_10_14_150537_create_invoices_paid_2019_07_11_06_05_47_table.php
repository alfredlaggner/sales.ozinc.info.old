...
class CreateInvoicesPaid20190711060547Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('invoices_paid_2019_07_11_06_05_47', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('invoices_paid_2019_07_11_06_05_47');
    }
}
