...
class CreateInvoicesPaid20190813072141Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('invoices_paid_2019_08_13_07_21_41', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('invoices_paid_2019_08_13_07_21_41');
    }
}
