...
class CreateSaleslines20190513022031Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('saleslines_2019_05_13_02_20_31', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('saleslines_2019_05_13_02_20_31');
    }
}
