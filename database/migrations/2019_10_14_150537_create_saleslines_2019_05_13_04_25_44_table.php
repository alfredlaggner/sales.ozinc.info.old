...
class CreateSaleslines20190513042544Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('saleslines_2019_05_13_04_25_44', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('saleslines_2019_05_13_04_25_44');
    }
}
