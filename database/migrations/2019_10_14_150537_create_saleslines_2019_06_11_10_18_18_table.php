...
class CreateSaleslines20190611101818Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('saleslines_2019_06_11_10_18_18', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('saleslines_2019_06_11_10_18_18');
    }
}
