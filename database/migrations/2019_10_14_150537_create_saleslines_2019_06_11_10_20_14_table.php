...
class CreateSaleslines20190611102014Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('saleslines_2019_06_11_10_20_14', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('saleslines_2019_06_11_10_20_14');
    }
}
