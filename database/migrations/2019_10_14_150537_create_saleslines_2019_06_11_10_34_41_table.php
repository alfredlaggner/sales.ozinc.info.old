...
class CreateSaleslines20190611103441Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('saleslines_2019_06_11_10_34_41', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('saleslines_2019_06_11_10_34_41');
    }
}
