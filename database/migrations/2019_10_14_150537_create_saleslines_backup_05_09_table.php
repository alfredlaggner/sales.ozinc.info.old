...
class CreateSaleslinesBackup0509Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('saleslines_backup_05_09', function (Blueprint $table) {
    ...
    {
        Schema::drop('saleslines_backup_05_09');
    }
}
